        ...
        <div className="col-lg-9">
          <div className="mt-8">
            ...
            <p>
              ...
              <b className="secondary">padding</b> values to an element or a subset of its sides
              with shorthand classes. Includes support for individual properties, all properties,
              and vertical and horizontal properties. Classes are built from a default Sass map
              ranging from <b className="secondary">0rem</b> to <b className="secondary">6rem</b>.
            </p>
          </div>
          <div className="mt-8">
            <h3 className="mb-2">Notation</h3>
            <p>
              Spacing utilities that apply to all breakpoints, from <b className="secondary">xs</b>{' '}
              to <b className="secondary">xl</b>, have no breakpoint abbreviation in them. This is
              because those classes are applied from <b className="secondary">min-width: 0</b> and
              up, and thus are not bound by a media query. The remaining breakpoints, however, do
              include a breakpoint abbreviation.
            </p>
            <p>
              The classes are named using the format{' '}
              <b className="secondary">&#123;property&#125; &#123;sides&#125;-&#123;size&#125;</b>{' '}
              for
            ...
            <ul>
              <li>
                ...
                <b className="secondary">margin</b> or <b className="secondary">padding</b> by
                setting it to <b className="secondary">0</b>
              </li>
              <li>
